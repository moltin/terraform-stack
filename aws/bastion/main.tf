...
module "sg_ssh" {
    source = "git::ssh://git@github.com/moltin/terraform-modules.git//aws/networking/security_group/sg_ssh?ref=0.2.2"
...
module "ami" {
    source = "git::ssh://git@github.com/moltin/terraform-modules.git//aws/data/ubuntu_ami?ref=0.2.2"
