...
module "vpc" {
    source = "git::ssh://git@github.com/moltin/terraform-modules.git//aws/networking/vpc?ref=0.2.2"
...
module "igw" {
    source = "git::ssh://git@github.com/moltin/terraform-modules.git//aws/networking/internet_gateway?ref=0.2.2"
...
module "public_subnet" {
    source = "git::ssh://git@github.com/moltin/terraform-modules.git//aws/networking/public_subnet?ref=0.2.2"
...
module "private_subnet" {
    source = "git::ssh://git@github.com/moltin/terraform-modules.git//aws/networking/private_subnet?ref=0.2.2"
